...
public class DualCounterDialog extends DialogFragment {
    Bundle bundle;
    ...
    public interface DualCounterDialogListener {
        void onDualCounterDialogPositiveClick(Cell newCell, boolean location, int position, int realId);
    }

    DualCounterDialogListener listener;
    ...
    public void onAttach(@NonNull Context context) {
        ...
        try {
            ...
            listener = (DualCounterDialogListener) context;
        } catch (ClassCastException e) {
            // The activity doesn't implement the interface, throw exception
            throw new ClassCastException(requireActivity()
                    + " must implement CounterDisplayDialogListener");
        }
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.popup_dualcounter, null);
        ...
        if (preference.getBoolean("edit_mode")) {
            ...
            deleteButton.setOnClickListener(v1 -> {
                listener.onDualCounterDialogPositiveClick(null, location, viewId, realId);
                if (DualCounterDialog.this.getDialog() != null) {
                    DualCounterDialog.this.getDialog().cancel();
                }
            });
        }
        ...
        builder.setView(v)
                ...
                .setPositiveButton(utils.textSelector(), (dialog, id) -> {
                    ...
                    String cellType = getString(R.string.CounterDisplayType);
                    ...
                    listener.onDualCounterDialogPositiveClick(newCell, location, viewId, realId);
                })
